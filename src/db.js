...
/**
 * Writes data to VIDEOS, PRODUCTS and associated join tables
...
/**
 * Populate "admin" & "user" user_types and add given users to users table
 * @param {Array<Object>} an array of user objects
 */
